//------------------------------------------------------------------------------
//
// File Name:	CreditScrollBehavior.h
...
namespace Dapper {
  ...
  class CreditScrollBehavior : public IComponent
  {
  public:

    // Constructor and Destructor
	CreditScrollBehavior(int ID_, Engine& engine_);
    ~CreditScrollBehavior() override;
